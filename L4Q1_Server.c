...
int main()
{
	...
	strcpy(stu[0].student_id,"210911052");
	strcpy(stu[1].student_id,"210911053");
	strcpy(stu[0].subject_id[0],"NPS");
	strcpy(stu[0].subject_id[1],"DBS");
	strcpy(stu[0].subject_id[2],"SE");
	strcpy(stu[1].subject_id[0],"NPS");
	strcpy(stu[1].subject_id[1],"MLP");
	strcpy(stu[1].subject_id[2],"BDM");
	strcpy(stu[0].fname,"Shashwat");
	strcpy(stu[1].fname,"Random");
	strcpy(stu[0].lname,"Kumar");
	strcpy(stu[1].lname,"Name");
